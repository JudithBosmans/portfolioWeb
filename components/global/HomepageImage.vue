...
<template>
  <div>
    ...
    <div
      v-else
      class="back bg-cover bg-center h-full bg-blue-200"
      :style="{
      ...
      <div class="info flex flex-col justify-center h-screen">
        <div class="container text-center p-1 lg:p-20">
          <div>
            ...
            <div class="flex container absolute bottom-0 align-items: center;">
              <div class="flex basis-1/12">
                <div class="flex-1 basis-4/12 p-2 p-4">
                  <NuxtLink to="/">
                    <svg
                ...
                <div class="flex-1 basis-4/12 p-2">
                  <NuxtLink to="/search">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="2em"
                ...
                <div class="flex-1 basis-4/12 p-2 text-right">
                  <NuxtLink
